...
describe("bundled uploaded display fonts", () => {
  it("registers the supported uploaded font pack with detected weights", () => {
    expect(displayFonts).toHaveLength(26);
    expect(displayFonts.flatMap((font) => font.sources)).toHaveLength(100);
