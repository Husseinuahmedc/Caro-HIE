...
const ROLE_CONTENT: Record<string, RoleContentDefaults> = {
  ...
  problem: { title: "المشكلة مو بالظاهر", body: "اكتب المشكلة التي يعيشها جمهورك بجملة قصيرة ومباشرة." },
  explanation: { title: "خلّينا نفككها", body: "اشرح الفكرة خطوة بخطوة، وخلي كل شريحة تحمل معنى واحداً." },
  code: { title: "السطر المهم", body: "اقرأ الكود ضمن سياقه.", code: "const result = await doSomething()" },
  summary: { title: "الخلاصة", body: "نقطة واحدة يتذكرها القارئ بعد ما يمر على السلسلة." },
  cta: { title: "شنو خطوتك الجاية؟", body: "احفظها وجرّبها اليوم." },
  answer: { title: "الجواب: نعم، بس...", body: "ابدأ بالجواب ثم أضف السبب الذي يحتاجه القارئ." },
  why: { title: "ليش يصير هذا؟", body: "أعطِ سياقاً بسيطاً يربط السؤال بالنتيجة." },
